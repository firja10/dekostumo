...
<body>
  ...
  <br>
      ...
      while($baris_id = mysqli_fetch_assoc($hasil_select_id))
      {
        ...
        $gambar_dua_id = "./assets/img/baju/" . $baris_id['gambar1'];
        $gambar_tiga_id = "./assets/img/baju/" . $baris_id['gambar1'];
      ...
      ?>
        ...
        <div class="col-lg-8 d-flex flex-column justify-content-center" data-aos="zoom-out" data-aos-delay="200">
         <img src="<?php echo $product_image_id  ?>" alt="">
         <br>
         <center>
          <ul style = "list-style-type: none; overflow:hidden">
            <li style = "float:left"><img src="<?php echo $product_image_id  ?>" alt="" style = "width:100px;margin-left: 15px; margin-right:15px;"></li>
            <li style = "float:left"><img src="<?php echo $gambar_satu_id  ?>" alt="" style = "width:100px;margin-left: 15px; margin-right:15px;"></li>
            <li style = "float:left"><img src="<?php echo $gambar_dua_id  ?>" alt="" style = "width:100px;margin-left: 15px; margin-right:15px;"></li>
            <li style = "float:left"><img src="<?php echo $gambar_tiga_id  ?>" alt="" style = "width:100px;margin-left: 15px; margin-right:15px;"></li>
        ...
        <div class="col-lg-4 d-flex flex-column justify-content-center" data-aos="zoom-out" data-aos-delay="200">
          ...
          <div style = "text-align:right">
            ...
            <ul style = "list-style-type: none; overflow:hidden; margin-top:10px;">
              <li style = "float:left"><img src="<?php echo $gambar_satu_id  ?>" alt="" style = "width:85px;margin-left: 10px; margin-right:10px;"></li>
              <li style = "float:left"><img src="<?php echo $gambar_dua_id  ?>" alt="" style = "width:85px;margin-left: 10px; margin-right:10px;"></li>
              <li style = "float:left"><img src="<?php echo $gambar_tiga_id  ?>" alt="" style = "width:85px;margin-left: 10px; margin-right:10px;"></li>
